...
import { Plus, LayoutDashboard, FileText, MessageCircle, User as UserIcon, LogOut, Heart, Search, MapPin, ShieldAlert } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FB] pb-12">
            ...
            <header className="bg-white border-b border-slate-100 sticky top-0 z-50 shadow-sm">
                <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-6 flex-shrink-0">
                        <Link href="/app" className="flex items-center gap-2 group">
                            <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center text-white font-black text-2xl italic shadow-lg shadow-primary/20 group-hover:scale-105 transition-transform">S</div>
                            <span className="text-2xl font-black tracking-tighter text-slate-900 hidden sm:block uppercase">Snabb</span>
                        </Link>
                        ...
                        <button className="hidden lg:flex items-center gap-2 text-slate-500 hover:text-primary transition-colors group">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-xs font-bold text-slate-800 flex items-center gap-1 leading-none">
                                    New York, NY <span className="text-[8px]">▼</span>
                                </p>
                            </div>
                        </button>
                    </div>
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                        ...
                        <Link href="/app/messages" className="w-12 h-12 bg-slate-50 hover:bg-slate-100 rounded-2xl flex items-center justify-center text-slate-500 transition-all relative group">
                        ...
                        <button 
                            ...
                            className="w-12 h-12 bg-slate-50 hover:bg-red-50 rounded-2xl flex items-center justify-center text-slate-400 hover:text-red-500 transition-all group"
                        >
                            <LogOut className="w-5 h-5 group-hover:scale-110 transition-transform" />
                        </button>

                        <Link href="/app/profile" className="flex items-center gap-3 pl-2 group">
                            <div className="w-11 h-11 rounded-2xl border-2 border-slate-100 bg-gradient-to-tr from-slate-100 to-slate-200 flex items-center justify-center text-slate-500 font-black transition-all group-hover:border-primary/30 shadow-sm">
                ...
                {/* Secondary Nav Bar */}
                <nav className="border-t border-slate-50 bg-white shadow-sm overflow-x-auto no-scrollbar">
