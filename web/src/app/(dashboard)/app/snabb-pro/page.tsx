...
export default function SnabbProHubPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-10 py-10 px-4">
            ...
            {!user?.is_pro && (
                <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-[2rem] p-10 flex flex-col lg:flex-row items-center justify-between gap-8 text-white shadow-xl shadow-emerald-500/20">
