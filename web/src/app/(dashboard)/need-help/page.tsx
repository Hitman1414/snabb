...
export default function NeedHelpHubPage() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10 py-10">
            {/* Header */}
            <div className="relative p-12 bg-red-50 rounded-[3rem] overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-red-100/50 -skew-x-12 translate-x-10" />
                
                <button 
                    onClick={() => router.back()}
                    className="mb-8 flex items-center gap-2 text-red-700 font-bold hover:gap-3 transition-all"
                >
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <h1 className="text-5xl font-black text-red-900 tracking-tight">NEED HELP?</h1>
                    <p className="text-xl text-red-700/80 max-w-xl font-medium leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {actions.map((action, index) => (
                            <Link 
                                key={index} 
                                href={action.href}
                                className="flex items-center gap-6 p-6 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl hover:border-red-500/30 hover:shadow-xl hover:shadow-red-500/5 transition-all group"
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-500 font-medium">{action.subtitle}</p>
                                </div>
