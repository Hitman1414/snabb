                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-row flex-wrap gap-4 items-center">
                                <div className="relative group">
                                    <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl px-7 py-3.5 opacity-60 grayscale cursor-not-allowed transition-all min-w-[180px]">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-[10px] text-primary font-black uppercase tracking-widest leading-none mb-1">Coming Soon</span>
                                            <span className="text-base font-black text-white leading-tight">App Store</span>
                                        </div>
                                    </div>
                                    <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-white text-black text-[10px] font-black px-3 py-1.5 rounded-lg shadow-2xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-30 pointer-events-none">
                                        Use our Web App instead!
                                    </div>
                                </div>

                                <a
                                    href="/download"
                                    className="flex items-center gap-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-2xl px-7 py-3.5 transition-all group min-w-[180px]"
                                >
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7 text-white shrink-0 group-hover:scale-110 transition-transform">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] text-slate-400 font-bold uppercase leading-none mb-1 tracking-wide">Get it on</span>
                                        <span className="text-base font-black text-white leading-tight">Google Play</span>
                                    </div>
                                </a>
                            </div>
                            <div className="flex items-center gap-3">
                                <Link href="/app" className="group flex items-center gap-3 text-slate-500 hover:text-primary transition-all px-1">
                                    <div className="w-2 h-2 bg-primary rounded-full animate-pulse shadow-[0_0_10px_rgba(255,95,31,0.5)]"></div>
                                    <span className="text-[11px] font-black uppercase tracking-[0.2em]">Snabb Web App Live →</span>
                                </Link>
                            </div>
                        </div>
