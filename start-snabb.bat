...
echo   Starting Backend, Web App, and Mobile App...
echo ============================================================
echo.
...
echo [1/3] Starting Backend (FastAPI on http://localhost:%BACKEND_PORT%)...
...
echo [2/3] Starting Web App (Next.js webpack dev server on http://localhost:3000)...
start "Snabb Web" /d "%WEB%" cmd /k "npm run dev"

timeout /t 2 /nobreak >nul

echo [3/3] Starting Mobile App (Expo on port 8081)...
